...
func (o *Options) Flags() cliflag.NamedFlagSets {
	...
	//fs.BoolVar(&o.Opts.DisableTaint, "disable-taint", o.Opts.DisableTaint, "disable the virtual-kubelet node taint")
	...
	fs.DurationVar(&o.Opts.StartupTimeout, "startup-timeout", o.Opts.StartupTimeout, "How long to wait for the virtual-kubelet to start")
